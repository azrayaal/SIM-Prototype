...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <UserCircleIcon />,
    subItems: [
      { name: "Daftar Karyawan", path: "/daftar-karyawan", pro: false },
      { name: "Pengajuan Karyawan", path: "/pengajuan-karyawan", pro: false },
      // { name: "Aktivasi Karyawan", path: "/aktivasi-karyawan", pro: false },
    ],
  },
  {
    name: "Kontrak",
      ...
      >
        <Link to="/">
          {isExpanded || isHovered || isMobileOpen ? (
            ...
            <img src="/images/logo/sim.png" alt="Logo" width={32} height={32} />
          )}
        </Link>
      </div>
