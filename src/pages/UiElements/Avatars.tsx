...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Sagara - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Sagara - React.js Tailwind CSS Admin Dashboard Template"
      />
